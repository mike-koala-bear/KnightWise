...
export function Dashboard() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-6 space-y-5">
      ...
      {/* Onboarding banner (shows when skill test not done) */}
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link
          href="/galaxy"
          className="card-lift flex flex-col gap-2 rounded-2xl border border-kw-border bg-kw-surface p-4"
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-kw-purple/20 text-xl">
            🗺️
          </div>
          <div>
        ...
        >
          ...
          <div>
            <div className="text-xs font-bold uppercase tracking-wider text-kw-blue">
              Practice
            </div>
            <div className="mt-0.5 font-bold text-white">Drill Runner</div>
            <p className="mt-1 text-xs text-slate-400">
              Solve your next SRS puzzle.
            </p>
          </div>
        </Link>
      </div>
